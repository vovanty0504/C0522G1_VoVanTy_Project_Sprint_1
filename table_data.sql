...
select seat_type.price / 1000 into fc_point
from customer
...
movie.id as idMovie, movie.name as nameMovie,  show_times.date_projection as dateProjection, ticket.ticket_booking_time as bookingTime,
	seat_type.price *(1 - ifnull(promotion.discount, 0)/100) as money,
    seat_type.price *(1 - ifnull(promotion.discount, 0)/100)/1000 as point
